function [params,ct_area,bg_area, fg_area, area_resize_factor] = initializeAllAreas(im, params)
    ...
    ct_area =round(bg_area * params.context_factor); 
    ...
    params.norm_ct_area = round(ct_area * area_resize_factor);
